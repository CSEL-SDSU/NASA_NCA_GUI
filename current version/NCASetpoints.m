...
%   the app class may be difficult inside a function though.
    arguments (Input)
        ...
        display.fields struct {checkDisplayFields(display.fields)} = struct("signalA", 0, ...
                  "signalB", 0, ...
                  "signalC", 0, ...
                  "signalD", 0, ...
                  "flowA", 0, ...
                  "flowB", 0, ...
                  "flowC", 0, ...
                  "flowD", 0); %Struct containing the EditFields to be updated
    end
    arguments (Output)
    ...
    if display.updateFields
        ...
        display.fields.signalA.Value = calcFlow(QALargeSetpoint,MFCStruct.N2UnitLarge);
        display.fields.signalB.Value = calcFlow(QBLargeSetpoint,MFCStruct.O2UnitLarge);
        display.fields.signalC.Value = calcFlow(QASmallSetpoint,MFCStruct.N2UnitSmall);
        display.fields.signalD.Value = calcFlow(QBSmallSetpoint,MFCStruct.O2UnitSmall);
...
function checkMFCStructFields(MFCStruct)
    %Validator function to check if the MFCStruct has the correct fields
    % Correct fieldnames
    correctFields = ["N2UnitSmall";    "N2UnitLarge";    "O2UnitSmall";...
    "O2UnitLarge";    "N2UnitSmallMax";    "N2UnitLargeMax";...
    "N2UnitLargeMin";    "O2UnitSmallMax";    "O2UnitLargeMax";...
    "O2UnitLargeMin"];
    
    % [{'N2UnitSmall'   }    {'N2UnitLarge'   }...
    %     {'O2UnitSmall'   }    {'O2UnitLarge'   }    {'N2UnitSmallMax'}...
    % {'N2UnitLargeMax'}    {'N2UnitLargeMin'}    {'O2UnitSmallMax'}...
    % {'O2UnitLargeMax'}    {'O2UnitLargeMin'}];
